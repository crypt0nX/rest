  ...
  <view class="container">
    ...
    <view class="main">
      ...
      >
        ...
        <view class="main-content-startDate"
          >请假时间：{{ item.startDate }} 至 {{ item.endDate }} ({{
            item.countDate
          }})</view
        >
        <view class="main-content-startDate" v-if="item.state == '已完成'"
          >实际休假时间：<text :style="getDateStyle(i)"
            >{{ item.startDate }} ~ {{ item.endDate }} ({{
              item.countDate
            }})</text
          ></view
        >
        <view class="main-content-state" :style="getStateStyle(item.state)">{{
          item.state
        }}</view>
      </view>
